...
```
If a newer version exists, notify the user: `[UPDATE] AWP Skill X.Y.Z available (current: 0.24.9).` Skip this step if the network is unavailable.
